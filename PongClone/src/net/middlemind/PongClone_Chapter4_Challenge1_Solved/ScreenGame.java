package net.middlemind.PongClone_Chapter4_Challenge1_Solved;
...
public class ScreenGame extends Screen {
    ...
    **********************************************************
    * Description: 
    * Find the package, net.middlemind.PongClone_Chapter4_Challenge1, and open the ScreenGame.java file.
    * Some of the testers are reporting that it's kind of difficult to control the paddles when playing a two-player
    * game. We'll have to map 2 new sets of 2 keys each to add new paddle down, up controls for player 1 and 2.
    * Find the ProcessKeyPress and ProcessKeyRelease methods of the ScreenGame class. You'll have to use your
    * knowledge of Java flow control statements to add support for 2 new sets keyboard keys. One for player1 to move the
    * paddle up and down and a set for player2. Use the code that's already in place for player1 as a template.
    * You must run this package's file - PongClone.java - right-click and select Run-File, to test the game.
    * 
    * Clue:
    * You'll have to set the following variables to true or false depending on the keyboard key used and if the key is
    ...
    * paddle2MoveDown
    * 
    * Remember, you have to reset the Boolean variable in the key release method, ProcessKeyRelease, otherwise the player's 
    * paddle will be stuck moving either up or down.
    * 
    * Search for "CHAPTER 4 CHALLENGE 1 SOLUTION" to find all the solution text.
    */
    ...
    /*********************************************************
    ************* CHAPTER 4 CHALLENGE 1 SOLUTION *************
    **********************************************************
    * Solution: 
    * For our solution we chose to map keys 1,2 to player1's paddle down and up controls respectively.
    * For player2 we decided to map keys 9,0 to player2's paddle down and up controls. We placed the new
    * key press code in the class' ProcessKeyPress method for two player games only but you could have chose to
    * implement the input controls for a mixture of both. Lastly, we need to update the ProcessKeyRelease method
    * so that the game controls reset when the key is released. The two methods below demonstrate one possible solution
    * to the challenge.
    */     
