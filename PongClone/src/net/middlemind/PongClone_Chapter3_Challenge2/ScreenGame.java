package net.middlemind.PongClone_Chapter3_Challenge2;
...
public class ScreenGame extends Screen {
    ...
    * and replace them with if-else that test an array value. The new code is in the DrawScreen method but it
    * is currently commented. You need to define and initialize a new array called "numbers" of length 4. This array should 
    * be initialized with each value in the NumberState enumeration. Use the following statements to get the integer values
    * for the array.
    * 
    ...
    public void DrawScreen() {
        ...
        switch(state) {
            ...
            case SHOW_COUNT_DOWN:
                ...
                **********************************************************
                * Note:
                * The new code that will use the array field in an if-else statement
                * as opposed to a switch statement.
                */                
