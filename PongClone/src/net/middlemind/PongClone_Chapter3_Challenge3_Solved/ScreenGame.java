package net.middlemind.PongClone_Chapter3_Challenge3_Solved;
...
public class ScreenGame extends Screen {
    ...
    **********************************************************
    * Description: 
    * Find the package, net.middlemind.PongClone_Chapter3_Challenge3, and open the ScreenGame.java file.
    * After reviewing the changes made in the last challenge some members of the development team
    * want to use a data structure with a dynamic length instead of an array. You're challenge is to refactor the working code
    * in this file so that the "numbers" variable is an ArrayList as opposed to an array. You'll also
    * have to adjust how the variable is initialized and comment out the old code while uncommenting the new code 
    * in the class' DrawScreen method. If you've done everything correctly the game should run without error. 
    * You must run this package's file - PongClone.java - right-click and select Run-File, to test the game.
    * 
    * Clue:
    * Aside from commenting out the current code in the DrawScreen method that handles the SHOW_COUNT_DOWN_IN_GAME 
    * and SHOW_COUNT_DOWN game states all you have to do is convert the numbers variable from an array to an ArrayList.
    * 
    * Search for "CHAPTER 3 CHALLENGE 3 SOLUTION" to find all the solution text.
    */
    ...
    /*********************************************************
    ********** CHAPTER 3 CHALLENGE 3 SOLUTION PART 1 *********
    **********************************************************
    * Solution:
    * The first part of the solution requires us to convert the numbers variable
    * from an array to an ArrayList. Make sure to import any necessary Java system
    * packages.
    */
    ...
    public void LoadResources() {
        ...
        /*********************************************************
        ********** CHAPTER 3 CHALLENGE 3 SOLUTION PART 2 *********
        **********************************************************
        * Solution: 
        * The second part of the solution requires the ArrayList to be initialized using 
        * the ArrayList statement for adding values.
        */
        
        numbers = new ArrayList();
        numbers.add(NumberState.NONE.ordinal());
        numbers.add(NumberState.NUMBER_1.ordinal());
        numbers.add(NumberState.NUMBER_2.ordinal());
        numbers.add(NumberState.NUMBER_3.ordinal());        
        ...
        switch(state) {
            ...
            case SHOW_COUNT_DOWN:
                ...
                */
                ...
                /*********************************************************
                ********** CHAPTER 3 CHALLENGE 3 SOLUTION PART 3 *********
                **********************************************************
                * Solution: 
                ...
                */
                ...
                //NEW CODE START
                // <editor-fold>
                if(numberState.ordinal() == numbers.get(0)) {
                    // <editor-fold>                        
                    timeNumberMs = System.currentTimeMillis();
                    numberState = NumberState.NUMBER_3;
                    number1.SetIsVisible(false);
                ...
                } else if(numberState.ordinal() == numbers.get(1)) {
                    // <editor-fold>
                    timeTmpMs = System.currentTimeMillis();
                    if(timeTmpMs - timeNumberMs >= timeNumberDisplayMs) {
                        timeNumberMs = timeTmpMs;
                ...
                } else if(numberState.ordinal() == numbers.get(2)) {
                    // <editor-fold>
                    timeTmpMs = System.currentTimeMillis();
                    if(timeTmpMs - timeNumberMs >= timeNumberDisplayMs) {
                        timeNumberMs = timeTmpMs;
                ...
                } else if(numberState.ordinal() == numbers.get(3)) {
                    // <editor-fold>
                    timeTmpMs = System.currentTimeMillis();
                    if(timeTmpMs - timeNumberMs >= timeNumberDisplayMs) {
                        timeNumberMs = timeTmpMs;
