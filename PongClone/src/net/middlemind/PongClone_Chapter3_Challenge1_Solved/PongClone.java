package net.middlemind.PongClone_Chapter3_Challenge1_Solved;
...
public final class PongClone {
    ...
    **********************************************************
    * Description: 
    * Find the package, net.middlemind.PongClone_Chapter3_Challenge1, and open the PongClone.java file.
    * This version of the game accidentally had a bug introduced after testing.
    * An inadvertent key strike has altered a variable value and broken the game.
    * Your challenge is to find the variable that has the incorrect value and fix it.
    * You must run this file - PongClone.java - right-click and select Run-File, to test the game.
    * 
    * Clue:
    * The PongClone video game uses a game engine config file to data drive some aspects
    * of the game's configuration. The null pointer exception that the game throws when 
    * loading is caused by a game engine configuration error.
    * 
    * Search for "CHAPTER 3 CHALLENGE 1 SOLUTION" to find all the solution text.
    */    
    ...
    /*********************************************************
    ************* CHAPTER 3 CHALLENGE 1 SOLUTION *************
    **********************************************************
    * Solution: 
    * The String variable, ENGINE_CONFIG_FILE, had an error in its value.
    * The configuration filename specified had a typo, the 'o' in 'pong' had been 
    * accidentally deleted. Fixing the typo and checking it against the actual file name
    * on the file system fixed the problem.
    */ 
