package net.middlemind.PongClone_Chapter3_Challenge2_Solved;
...
public class ScreenGame extends Screen {
    ...
    **********************************************************
    * Description: 
    * Find the package, net.middlemind.PongClone_Chapter3_Challenge2, and open the ScreenGame.java file.
    * The lead developer doesn't like so many switch statements in the DrawScreen method.
    * They would like to remove the switch statements for the SHOW_COUNT_DOWN_IN_GAME and SHOW_COUNT_DOWN game states
    * and replace them with if-else statements that test an array value. The new code is in the DrawScreen method, 
    * but it is currently commented out. You need to define and initialize a new integer array called "numbers" of length 4. 
    * This array should be initialized with each value in the NumberState enumeration. Use the following statements to get 
    * the integer values for the elements of the array.
    * 
    ...
    * 
    * You can initialize the array in any way that works but it is recommended you use the LoadResources method
    * You must run this package's file - PongClone.java - right-click and select Run-File, to test the game.
    * 
    * Clue:
    * If you are unsure about what values to set for the numbers array take a look at the commented out new code 
    * in the DrawScreen method. If you're concerned about where to place your initialization code in the LoadResources method
    * use a spot near the end of the method.
    * 
    * Search for "CHAPTER 3 CHALLENGE 2 SOLUTION" to find all the solution text.
    */
    ...
    /*********************************************************
    ********** CHAPTER 3 CHALLENGE 2 SOLUTION PART 1 *********
    **********************************************************
    * Solution: 
    * The first part of the solution requires a new array of integers to be declared.
    * You don't have to use the private keyword, any form of declaration would work here.
    */
    
    /**
     * An array of integers used to hold the numbers in the countdown.
     */
    private int[] numbers;
    ...
    public void LoadResources() {
        ...
        /*********************************************************
        ********** CHAPTER 3 CHALLENGE 2 SOLUTION PART 2 *********
        **********************************************************
        * Solution: 
        * The second part of the solution requires the array to be initialized using the 
        * statements provided in the challenge.
        */
        
        numbers = new int[4];
        numbers[0] = NumberState.NONE.ordinal();
        numbers[1] = NumberState.NUMBER_1.ordinal();
        numbers[2] = NumberState.NUMBER_2.ordinal();
        numbers[3] = NumberState.NUMBER_3.ordinal();        
        ...
        switch(state) {
            ...
            case SHOW_COUNT_DOWN:
                ...
                */
                ...
                /*********************************************************
                ********** CHAPTER 3 CHALLENGE 2 SOLUTION PART 3 *********
                **********************************************************
                * Solution: 
                * The last part of the solution requires us to comment the block of code 
                * above and remove the code comment around the code below.
                */
                
                //NEW CODE START
                // <editor-fold>
                if(numberState.ordinal() == numbers[0]) {
                    // <editor-fold>                        
                    timeNumberMs = System.currentTimeMillis();
                    numberState = NumberState.NUMBER_3;
                    number1.SetIsVisible(false);
                ...
                } else if(numberState.ordinal() == numbers[1]) {
                    // <editor-fold>
                    timeTmpMs = System.currentTimeMillis();
                    if(timeTmpMs - timeNumberMs >= timeNumberDisplayMs) {
                        timeNumberMs = timeTmpMs;
                ...
                } else if(numberState.ordinal() == numbers[2]) {
                    // <editor-fold>
                    timeTmpMs = System.currentTimeMillis();
                    if(timeTmpMs - timeNumberMs >= timeNumberDisplayMs) {
                        timeNumberMs = timeTmpMs;
                ...
                } else if(numberState.ordinal() == numbers[3]) {
                    // <editor-fold>
                    timeTmpMs = System.currentTimeMillis();
                    if(timeTmpMs - timeNumberMs >= timeNumberDisplayMs) {
                        timeNumberMs = timeTmpMs;
