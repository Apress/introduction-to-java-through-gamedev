package net.middlemind.DungeonTrap_Chapter8_Challenge1;
...
public class MdtWeaponSpear extends MdtWeapon {
    ...
    * for player and enemy characters in the game. You must run this package's file - DungeonTrap.java - right-click 
