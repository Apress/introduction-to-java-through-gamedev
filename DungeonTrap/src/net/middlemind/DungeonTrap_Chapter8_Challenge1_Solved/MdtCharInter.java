...
public class MdtCharInter extends MdtChar {
    ...
    public MdtCharInter(MmgSprite Subj, int FrameFrontS, int FrameFrontE, int FrameBackS, int FrameBackE, int FrameLeftS, int FrameLeftE, int FrameRightS, int FrameRightE, ScreenGame Screen, MdtObjType ObjType, MdtObjSubType ObjSubType) {
        ...
        /*********************************************************
        ********* CHAPTER 8 CHALLENGE 1 SOLUTION PART 4 **********
        **********************************************************
        * Solution:
        * The last change we're asked to make it to add the weapon
        * as the default to the class the is the super class for both
        * enemy and player characters.
        */   

        weapons.put("spear_flame", new MdtWeaponSpearFlame(this, MdtWeaponType.SPEAR, MdtPlayerType.ENEMY));        
        weaponCurrent = weapons.get("spear_flame");
