...
public class ScreenGame extends Screen {
    ...
    /**
     * The current state of the countdown number.
     */
    ...
    /**
     * A background image used to frame the countdown numbers.
     */
            ...
            if(gameType == GameType.GAME_ONE_PLAYER || gameType == GameType.GAME_TWO_PLAYER) {
                if(src == ScreenGame.SRC_PLAYER_1) {
                    if(!player1.isAttacking) {
                        ...
                        /*********************************************************
                        ********* CHAPTER 8 CHALLENGE 3 SOLUTION PART 4 **********
                        **********************************************************
                        * Solution:
                        * The last thing we need to do is support adding a copy of the weapon to
                        * the game when it is thrown. This combined with the new methods added
                        * to the MdtWeaponSpearFlame.java class allow the weapon to move independently
                        * and allow for infinite copies to throw.
                        */
                        
                        if(player1.weaponCurrent.attackType == MdtWeaponAttackType.THROWING && (player1.weaponCurrent.weaponType == MdtWeaponType.AXE || player1.weaponCurrent.weaponType == MdtWeaponType.SPEAR)) {
                    ...
                    if(!player2.isAttacking) {
                        ...
                        /*********************************************************
                        ********* CHAPTER 8 CHALLENGE 2 SOLUTION PART 5 **********
                        **********************************************************
                        * Solution:
                        * This change is the same as in part 4 of the solution.
                        * Here we are adding support for player 2. Notice that the change
                        * to the if statement is similar to the change made in part 4 of
                        * the solution.
                        */                                                

                        if(player2.weaponCurrent.attackType == MdtWeaponAttackType.THROWING && (player2.weaponCurrent.weaponType == MdtWeaponType.AXE || player2.weaponCurrent.weaponType == MdtWeaponType.SPEAR)) {                                                
