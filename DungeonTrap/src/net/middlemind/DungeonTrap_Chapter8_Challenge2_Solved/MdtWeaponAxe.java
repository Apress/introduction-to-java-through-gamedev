...
public class MdtWeaponAxe extends MdtWeapon {
    ...
    //SOLUTION HERE, CODE IS USED FROM THIS CLASS
    //to customize the MdtWeaponSpearFlame class
    ...
    /*********************************************************
    *** CHAPTER 8 CHALLENGE 2 SOLUTION PART 1 SUPPLEMENTAL ***
    **********************************************************
    * Solution:
    * You can use these methods in the MdtWeaponSpearFlame class
    * because it is also an extension of the MdtWeapon class. This
    * exemplifies encapsulation, inheritance, and polymorphism in
