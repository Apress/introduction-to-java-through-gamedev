package net.middlemind.MemoryMatch_Chapter7_Challenge1_Solved;
...
public class ScreenGame extends Screen {
    ...
    **********************************************************
    * Description: 
    * Find the package, net.middlemind.MemoryMatch_Chapter7_Challenge1, and open the ScreenGame.java file. 
    * In this challenge you won’t be solving any problem for someone else you’ll be having a little fun adding 
    * a graphic to the video game that display at a certain position on the screen on certain game states. 
    * You can provide your own image, or you can use one of the included images. The images for this game 
    * project are stored in the following folder:
    * 
    * .\ MemoryMatch\cfg\drawable\MemoryMatch
    * 
    * You can use a png or jpg image of your own. The image should be around 200x200 pixels if you’re providing 
    * your own. Simply copy and paste the image into the directory mentioned previously and make sure to remember 
    * the name of the image file. If you don’t have one of your own just pick an image out of the directory and keep 
    * its name in mind.
    * 
    * Locate the LoadResources folder and find an example of the code used to load your own image into an MmgBmp class 
    * field. Add your own image variable named myImg to the class and initialize it at the bottom of the LoadResources 
    * method. You’ll also need to set the image’s position using the SetPosition method. And add the image to a container, 
    * MmgContainer, in the class so that it can be properly configured for display. You’ll get to know the MmgBmp class 
    * and some of its fields and methods as you complete this challenge.
    * 
    * In order to display the new image, you must add code to the SetState method for the SHOW_GAME game state. Take a 
    * look at the code in the method and specifically how images are shown and hidden depending on the current game state. 
    * Add your new image into the mix and follow the precedent set by the current code. Lastly, you’ll need to clean things 
    * up. Find the UnloadResources method and make sure to clean up your resources by setting the myImg class field to null. 
    * You must run this package's file - MemoryMatch.java - right-click and select Run-File, to test the game.
    * 
    * Clue:
    * If you run into trouble stop and take a moment to clear your mind. Look for an existing class field of the MmgBmp 
    * data type and trace how it’s used in the methods listed in this coding challenge. You can follow the same example 
    * except using your chosen filename, minus the extension.
    * 
    * Search for "CHAPTER 7 CHALLENGE 1 SOLUTION" to find all the solution text.
    */
