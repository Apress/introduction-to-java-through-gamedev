package net.middlemind.MemoryMatch_Chapter7_Challenge3_Solved;
...
public final class MemoryMatch {
    ...
    **********************************************************
    * Description: 
    * Find the package, net.middlemind.MemoryMatch_Chapter7_Challenge3, and open the MemoryMatch.java file. 
    * Some of the graphic artists on the project wanted to try out a new set of assets with the Memory Match 
    * game but don’t want to create a big drain on the developer’s time. Your challenge is to create a copy 
    * of the MemoryMatch.java static main and change the game engine configuration file it uses. Point it to 
    * this new file instead:
    * 
    ...
    * 
    * You’ll need to change the project settings to use the new static main file, run the specific file directly 
    * when testing, or use the correct console command to run the static main executable of your choice.
    * 
    * Clue:
    * Recall from your very first coding challenge you fixed a version of the Pong Clone game that was accidentally 
    * broken after testing. This challenge explored the connection between the Java project and its resources. 
    * Essentially, each game project uses a configuration file that sets the name of the video game and determines 
    * which folder to look for game resources.
    * 
    * By creating a new static main for the Memory Match game, you can specify a new game engine configuration file 
    * which will in turn specify a new set of resources to use for the game. Take your time to trace through any of 
    * the included video game project to get a better idea of how they are configured.
    * 
    * Search for "CHAPTER 7 CHALLENGE 3 SOLUTION" in the MemoryMatchTest.java file to find all the solution text.
    */
     ...
     */
    public static String ENGINE_CONFIG_FILE = "../cfg/engine_config_mmg_memory_match.xml";
