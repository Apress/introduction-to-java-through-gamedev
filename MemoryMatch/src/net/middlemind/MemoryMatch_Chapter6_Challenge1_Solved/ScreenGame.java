package net.middlemind.MemoryMatch_Chapter6_Challenge1_Solved;
...
public class ScreenGame extends Screen {
    ...
    * 
    * Search for "CHAPTER 6 CHALLENGE 1 SOLUTION" to find all the solution text.
    */
        ...
        if (pause == false && isVisible == true) {
            ...
            if(redXLeft.GetIsVisible() || redXRight.GetIsVisible() || greenCheckLeft.GetIsVisible() || greenCheckRight.GetIsVisible()) {
                if(MmgHelper.CtMs() - showResultStart >= showResultDuration) {
                    ...
                    /*********************************************************
                    ************* CHAPTER 6 CHALLENGE 1 SOLUTION *************
                    **********************************************************
                    * Solution: 
                    * Drop the len variable and create a new element variable, itm.
                    * In this case we want to set the value of the itm object's flipped
                    * field to false so that it returns to the un-flipped, card back 
                    * showing, state.
                    */         
                    
                    for(MemoryItem itm : clickedCards) {
                        itm.flipped = false;
                    }                    
                    clickedCards.clear();
                    clickFreeze = false;
