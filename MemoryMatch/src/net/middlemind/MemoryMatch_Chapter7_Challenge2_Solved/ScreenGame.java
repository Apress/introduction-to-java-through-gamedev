package net.middlemind.MemoryMatch_Chapter7_Challenge2_Solved;
...
public class ScreenGame extends Screen {
    ...
    * of our image.
    * 
    * Search for "CHAPTER 7 CHALLENGE 2 SOLUTION" to find all the solution text.
    */
    ...
    public boolean ProcessKeyPress(char c, int code) {
        if (state == State.SHOW_GAME && pause == false) {
            ...
            /*********************************************************
            ********* CHAPTER 7 CHALLENGE 2 SOLUTION PART 1 **********
            **********************************************************
            * Solution:
            * For this part of the solution we chose the 'L' key for movement left,
            * and the 'R' key for movement right. We didn't put any constraints on the
            * movement but that is easy enough to add from this point. Notice that the
            * input handler is placed outside of the 2 player code.
            */
            
            if(c == 'l' || c == 'L') {
                if(myImg != null) {
                    myImg.SetPosition(myImg.GetX() - 1, myImg.GetY());
                }
                return true;
            }
    ...
    public boolean ProcessKeyRelease(char c, int code) {
        if (state == State.SHOW_GAME && pause == false) {
            ...
            /*********************************************************
            ********* CHAPTER 7 CHALLENGE 2 SOLUTION PART 2 **********
            **********************************************************
            * Solution:
            * For this part of the solution we chose the 'H' key for hide,
            * and the 'J' key for show. Notice that the
            * input handler is placed outside of the 2 player code.
            */
